...
exports.exportedForTesting = exports.addEditable = void 0;
 ...
 */
var addEditable = function (container, sqore, onCircuitChange) {
...
exports.addEditable = addEditable;
/**
...
var _hostElems = function (container) {
    return Array.from(container.querySelectorAll('[class^="gate-"]:not(.gate-control, .gate-swap), .control-dot, .oplus, .cross'));
};
/**
...
var _wireData = function (container) {
    ...
    var elems = container.querySelectorAll('svg > g:nth-child(3) > g');
 ...
 */
var _addContextMenuEvents = function (container) {
 ...
 */
var _renderFn = function (container, sqore, onCircuitChange) {
    return function () {
        sqore.draw(container, 0, true, onCircuitChange);
        if (onCircuitChange)
            onCircuitChange(sqore.circuit);
    };
};
/**
